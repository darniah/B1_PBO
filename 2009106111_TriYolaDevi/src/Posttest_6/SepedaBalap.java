...
public final class SepedaBalap extends Sepeda{

    public SepedaBalap(int id, String merk, String noseri, String ukuransepeda, String warnasepeda, int jumlahroda, int harga) {
