...
static void menu() {
        ...
        System.out.println("\t\t\t||===========================================");
        System.out.println("\t\t\t|| PROGRAM DATA PEMAIN BOLA KOTA SAMARINDA ||");
        System.out.println("\t\t\t||   nama pelatih = "+ implemen.pelatih);
...
static void lihatCadangan(String team){
        clearScreen();
        System.out.println("\n\n\n");
        System.out.println("\t\t\t    ===================================");
        ...
        if(data_no_punggungCadangan.isEmpty()) System.out.println("Data Kosong!");
            ...
            System.out.println("Berada di team " +team);
...
static void lihatInti(String team){
        clearScreen();
        System.out.println("\n\n\n");
        System.out.println("\t\t\t    ===================================");
        System.out.println("\t\t\t   || DATA PEMAIN BOLA KOTA SAMARINDA ||");
...
static void lihat(){
    Scanner masukkan = new Scanner(System.in);
     implemen impl = new implemen();
        ...
        System.out.println("\t\t\t|| [2] PEMAIN CADANGAN                         ||");
        System.out.println("\t\t\t|| [0] KEMBALI                                  ||");
        System.out.print("Latihan pada hari ");impl.latihan();
        System.out.print("Cuti pada hari ");impl.cuti();
        System.out.println("\t\t\t||=============================================||");
        System.out.print("\t\t\tPilih menu : ");
        int pilihMenu = masukkan.nextInt();
