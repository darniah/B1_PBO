...
public class Main {
    ...
    Manager joko = Karyawan("JOKO","Joko");
        
    public static void tambahdata() {
        Manager manager = new Manager("Joko", "Samarinda", "Staff", "Keuangan", 2002, 2019, 15, 2000000, 1000, 50000, 5000000);
