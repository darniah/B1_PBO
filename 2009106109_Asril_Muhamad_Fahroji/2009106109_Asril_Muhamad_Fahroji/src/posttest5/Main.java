...
public class Main {
    ...
    public static void bacaBuku() {
        posttest5.Siswa nama = new posttest5.Siswa("", 0, 0);
        System.out.println("\n=============================");
        ...
        switch (kelas) {
            case 10:
                {
                    posttest5.bukuKelasX bacaX = new posttest5.bukuKelasX("", 0);
                    Scanner bukuX = new Scanner(System.in);
            ...
            case 11:
                {
                    posttest5.bukuKelasXI bacaXI = new posttest5.bukuKelasXI("", 0);
                    Scanner bukuXI = new Scanner(System.in);
                    System.out.print("Nama Buku : ");
            ...
            case 12:
                {
                    posttest5.bukuKelasXII bacaXII = new posttest5.bukuKelasXII("", 0);
                    Scanner bukuXII = new Scanner(System.in);
                    System.out.print("Nama Buku : ");
    ...
    public static void pinjamBuku() {
        posttest5.Siswa siswa = new posttest5.Siswa("", 0, 0);
        System.out.println("\n=============================");
        ...
        switch(kelas) {
            case 10:
                posttest5.bukuKelasX pinjamX = new posttest5.bukuKelasX("", 0);
                Scanner bukuX = new Scanner(System.in);
                ...
                break;
            case 11:
                posttest5.bukuKelasXI pinjamXI = new posttest5.bukuKelasXI("", 0);
                Scanner bukuXI = new Scanner(System.in);
                System.out.print("Masukkan Nama Buku  : ");
                ...
                break;
            case 12:
                posttest5.bukuKelasXII pinjamXII = new posttest5.bukuKelasXII("", 0);
                Scanner bukuXII = new Scanner(System.in);
                System.out.print("Masukkan Nama Buku  : ");
    ...
    public static void siswa() {
        posttest5.Siswa baru = new posttest5.Siswa("", 0, 0);
        baru.setNama("Asril");
        baru.setNisn(100502);
        baru.setKelas(10);
