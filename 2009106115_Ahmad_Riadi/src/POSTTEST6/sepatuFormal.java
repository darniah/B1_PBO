...
public class sepatuFormal extends sepatu implements Comparable<sepatuFormal>{
    ...
    public int compareTo(sepatuFormal comparestu) {
        int compareage=((sepatuFormal)comparestu).getHarga();
        /* For Ascending order*/
    ...
    public String toString() {
        return "[ KodeBarang=" + KodeBarang + ", Jenis=" + Jenis + ", Brand=" + Brand + ", JenisKulit=" + JenisKulit + ", Ukuran=" + Ukuran + ", Warna=" + Warna + ", Harga=" + Harga + "]";
    }
}
