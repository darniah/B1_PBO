...
public class sepatuNonFormal extends sepatu implements Comparable<sepatuNonFormal>{
    ...
    public int compareTo(sepatuNonFormal comparestu) {
        int compareage=((sepatuNonFormal)comparestu).getHarga();
        /* For Ascending order*/
    ...
    public String toString() {
        return "[ KodeBarang=" + KodeBarang + ", Jenis=" + Jenis + ", Brand=" + Brand + ", JenisPakai=" + JenisPakai + ", Ukuran=" + Ukuran + ", Warna=" + Warna + ", Harga=" + Harga + "]";
    }
}
