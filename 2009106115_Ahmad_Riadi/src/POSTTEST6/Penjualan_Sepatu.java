...
final class Penjualan_Sepatu {

    static final String Perusahaan = "PT.Samarinda Taka";

    static final void Banner() {
        System.out.println("||||||||||||||||||||||||||||||||||||| ");
        System.out.println("||         Man Accesorris         ||  ");
        System.out.println("  ||-----------------------------||   ");
        System.out.println("   ||     " + Perusahaan + "    ||    ");
        System.out.println("  ||-----------------------------||   ");
        System.out.println(" ||      SHOES AUGMENTY SHOP      ||  ");
        System.out.println("||||||||||||||||||||||||||||||||||||| ");
    }
...
//-----------------------Setter-------------------------------
        ...
        ARR.tambahBarang(new sepatuNonFormal("Slip On", "NF13", "Boats", "Aerostreet", 35, "Hijau", 21000));

        ARRF.tambahBarang(new sepatuFormal("Harimau", "F12", "Wingtip", "Reebok", 25, "Coklat", 120000));
        ...
        while (perulangan == 1) {
            ...
            System.out.println("   [5] Cari   List  Sepatu ");
            System.out.println("   [6] Urut   Harga Sepatu ");
            System.out.println("   [0] Exit Program\n");
            System.out.println("-----------------------------------");
            System.out.print("       Masukan Pilihan [0-6] : ");
            ...
            if (pilih_menu2 == 1) {
                if (pilih_menu == 1) {
                    ...
                    System.out.println("\n\n---------------------------------------");
                    System.out.println("            Harga Telah Di Sort     ");
                    System.out.println("---------------------------------------\n");
